...
public class MainFra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(MainFra.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(MainFra.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(MainFra.this, SupportActivity.class);
        ...
        aniLlTop = AnimationUtils.loadAnimation(MainFra.this, R.anim.descend);
        ...
        aniTitle1 = AnimationUtils.loadAnimation(MainFra.this, R.anim.fadein);
        aniTitle1.setStartOffset(600);
        aniTitle2 = AnimationUtils.loadAnimation(MainFra.this, R.anim.fadein);
    ...
    public void pageGram() {
        Intent intentGram = new Intent(MainFra.this, GrammarEng.class);
    ...
    public void pageConj() {
        Intent intentConj = new Intent(MainFra.this, ConjEng.class);
