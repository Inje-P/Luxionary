...
public class Lang101Eng_01_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lang101_eng_01_3);
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(Lang101Eng_01_3.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(Lang101Eng_01_3.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(Lang101Eng_01_3.this, SupportActivity.class);
        ...
        aniLayoutTitle = AnimationUtils.loadAnimation(Lang101Eng_01_3.this, R.anim.descend_fast);
        aniLayoutMain = AnimationUtils.loadAnimation(Lang101Eng_01_3.this, R.anim.fadein);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(Lang101Eng_01_3.this, Lang101Eng_01_2.class);
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // Prev & Next Buttons
                case R.id.btnPrev:
                    Intent intentPrev = new Intent(Lang101Eng_01_3.this, Lang101Eng_01_2.class);
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(Lang101Eng_01_3.this, Lang101Eng.class);
                ...
                case R.id.btnSidebar:
                    ...
                    break;
                case R.id.btnHome:
                    Intent intentHome = new Intent(Lang101Eng_01_3.this, MainActivity.class);
    ...
    private void dialogEnd() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intentEnd = new Intent(Lang101Eng_01_3.this, Lang101Eng.class);
