...
public class IntroTur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intro_tur);
        ...
        ani = AnimationUtils.loadAnimation(IntroTur.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(IntroTur.this, MainTur.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(IntroTur.this, MainActivity.class);
