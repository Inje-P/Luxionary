...
public class SigninActivity extends AppCompatActivity {
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSignup:
                    Intent intentAccount = new Intent(SigninActivity.this, SignupActivity.class);
                ...
                case R.id.btnSignin:
                    ...
                    if (strEmail == null || strPw == null) {
                        Toast.makeText(SigninActivity.this, "등록된 계정이 아닙니다.", Toast.LENGTH_SHORT).show();
                        break;
                    } else {
                        if (strEmail.equals(inputEmail) && strPw.equals(inputPw)) {
                            ...
                            Toast.makeText(SigninActivity.this, "계정 혹은 비밀번호가 일치하지 않습니다.", Toast.LENGTH_SHORT).show();
                            break;
                        }
                    }
            }
    ...
    private void showDialog() {
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intentAccount = new Intent(SigninActivity.this, WelcomeActivity.class);
