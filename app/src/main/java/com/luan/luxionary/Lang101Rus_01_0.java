...
public class Lang101Rus_01_0 extends AppCompatActivity {
    // Data from DB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lang101_rus_01_0);
        ...
        ani1 = AnimationUtils.loadAnimation(Lang101Rus_01_0.this, R.anim.descend);
        ani2 = AnimationUtils.loadAnimation(Lang101Rus_01_0.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intentAccount = new Intent(Lang101Rus_01_0.this, Lang101Rus_01_1.class);
