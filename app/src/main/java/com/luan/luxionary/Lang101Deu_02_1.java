...
public class Lang101Deu_02_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(Lang101Deu_02_1.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(Lang101Deu_02_1.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(Lang101Deu_02_1.this, SupportActivity.class);
        ...
        * */
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEnd = new Intent(Lang101Deu_02_1.this, Lang101Deu_02_2.class);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btnPrev:
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(Lang101Deu_02_1.this, Lang101Deu_02_2.class);
