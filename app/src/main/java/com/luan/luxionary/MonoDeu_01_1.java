...
public class MonoDeu_01_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mono_deu_01_1);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(MonoDeu_01_1.this, MonoDeu.class);
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // Prev & Next Buttons
                case R.id.btnPrev:
                    Intent intentPrev = new Intent(MonoDeu_01_1.this, MonoDeu.class);
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(MonoDeu_01_1.this, MonoDeu.class);
                ...
                case R.id.btnSidebar:
                    ...
                    break;
                case R.id.btnHome:
                    Intent intentHome = new Intent(MonoDeu_01_1.this, MainActivity.class);
