...
public class MainRus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(MainRus.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(MainRus.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(MainRus.this, SupportActivity.class);
        ...
        aniLayoutProfile = AnimationUtils.loadAnimation(MainRus.this, R.anim.descend);
        layoutProfile.startAnimation(aniLayoutProfile);
        tvTitle1 = (TextView) findViewById(R.id.tvTitle1);
        tvTitle1.setOnClickListener(mClickListener);
        tvTitle2 = (TextView) findViewById(R.id.tvTitle2);
        aniTitle1 = AnimationUtils.loadAnimation(MainRus.this, R.anim.fadein);
        aniTitle1.setStartOffset(600);
        aniTitle2 = AnimationUtils.loadAnimation(MainRus.this, R.anim.fadein);
        ...
        aniLayoutMain = AnimationUtils.loadAnimation(MainRus.this, R.anim.fadein);
    ...
    public void pageVoca() {
        Intent intentVoca = new Intent(MainRus.this, VocaRus.class);
    ...
    public void pageGram() {
        Intent intentGram = new Intent(MainRus.this, GrammarEng.class);
    ...
    public void pageConj() {
        Intent intentConj = new Intent(MainRus.this, ConjEng.class);
    ...
    public void pageGlobal() {
        Intent intentGlobal = new Intent(MainRus.this, GlobalEng.class);
