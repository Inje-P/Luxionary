...
public class IntroDeu extends AppCompatActivity {
    // Data from DB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intro_deu);
        ...
        ani = AnimationUtils.loadAnimation(IntroDeu.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(IntroDeu.this, MainDeu.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(IntroDeu.this, MainActivity.class);
