...
public class MonoRus_01_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mono_rus_01_1);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(MonoRus_01_1.this, MonoRus.class);
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // Prev & Next Buttons
                case R.id.btnPrev:
                    Intent intentPrev = new Intent(MonoRus_01_1.this, MonoRus.class);
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(MonoRus_01_1.this, MonoRus.class);
                ...
                case R.id.btnSidebar:
                    ...
                    break;
                case R.id.btnHome:
                    Intent intentHome = new Intent(MonoRus_01_1.this, MainActivity.class);
