...
public class IntroIta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intro_ita);
        ...
        ani = AnimationUtils.loadAnimation(IntroIta.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(IntroIta.this, MainIta.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(IntroIta.this, MainActivity.class);
