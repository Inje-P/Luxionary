...
public class Lang101Ita_02_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lang101_ita_02_1);
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(Lang101Ita_02_1.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(Lang101Ita_02_1.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(Lang101Ita_02_1.this, SupportActivity.class);
        ...
        * */
        ...
        setColorStateList(btnTitle, ContextCompat.getColor(this, R.color.ita_background), btnTitle.getCurrentTextColor());
        ...
        setColorStateList(btnText1_1, ContextCompat.getColor(this, R.color.ita_background), btnText1_1.getCurrentTextColor());
        setColorStateList(btnText1_2, ContextCompat.getColor(this, R.color.ita_background), btnText1_2.getCurrentTextColor());
        setColorStateList(btnText1_3, ContextCompat.getColor(this, R.color.ita_background), btnText1_3.getCurrentTextColor());
        setColorStateList(btnText1_4, ContextCompat.getColor(this, R.color.ita_background), btnText1_4.getCurrentTextColor());
        ...
        ani1_1 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani1_2 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani1_2.setStartOffset(200);
        ani1_3 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani1_3.setStartOffset(400);
        ani1_4 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani1_4.setStartOffset(600);

        // 2nd Section
        btnText2_1 = (Button) findViewById(R.id.btnText2_1);
        btnText2_2 = (Button) findViewById(R.id.btnText2_2);
        setColorStateList(btnText2_1, ContextCompat.getColor(this, R.color.ita_background), btnText2_1.getCurrentTextColor());
        setColorStateList(btnText2_2, ContextCompat.getColor(this, R.color.ita_background), btnText2_2.getCurrentTextColor());
        btnText2_1.setVisibility(View.INVISIBLE);
        btnText2_2.setVisibility(View.INVISIBLE);
        ani2_1 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani2_2 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ...
        setColorStateList(btnText3_1, ContextCompat.getColor(this, R.color.ita_background), btnText3_1.getCurrentTextColor());
        setColorStateList(btnText3_2, ContextCompat.getColor(this, R.color.ita_background), btnText3_2.getCurrentTextColor());
        setColorStateList(btnText3_3, ContextCompat.getColor(this, R.color.ita_background), btnText3_3.getCurrentTextColor());
        btnText3_1.setVisibility(View.INVISIBLE);
        btnText3_2.setVisibility(View.INVISIBLE);
        btnText3_3.setVisibility(View.INVISIBLE);
        ani3_1 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani3_2 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
        ani3_2.setStartOffset(200);
        ani3_3 = AnimationUtils.loadAnimation(Lang101Ita_02_1.this, R.anim.ascend_fast);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(Lang101Ita_02_1.this, Lang101Ita.class);
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                // Prev & Next Buttons
                case R.id.btnPrev:
                    Intent intentPrev = new Intent(Lang101Ita_02_1.this, Lang101Ita.class);
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(Lang101Ita_02_1.this, Lang101Ita_01_2.class);
                ...
                case R.id.btnSidebar:
                    ...
                    break;
                case R.id.btnHome:
                    Intent intentHome = new Intent(Lang101Ita_02_1.this, MainActivity.class);
    ...
    public void showSnackbar(String str) {
        ...
        View custom = getLayoutInflater().inflate(R.layout.snackbar_ita, null);
