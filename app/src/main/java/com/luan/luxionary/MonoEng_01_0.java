...
public class MonoEng_01_0 extends AppCompatActivity {
    // Data from DB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mono_eng_01_0);
        ...
        ani1 = AnimationUtils.loadAnimation(MonoEng_01_0.this, R.anim.descend);
        ani2 = AnimationUtils.loadAnimation(MonoEng_01_0.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intentAccount = new Intent(MonoEng_01_0.this, MonoEng_01_1.class);
