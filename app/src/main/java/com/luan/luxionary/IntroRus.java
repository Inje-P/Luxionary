...
public class IntroRus extends AppCompatActivity {
    // Data from DB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intro_rus);
        ...
        ani = AnimationUtils.loadAnimation(IntroRus.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(IntroRus.this, MainRus.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(IntroRus.this, MainActivity.class);
