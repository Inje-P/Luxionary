...
public class Lang101Ita_01_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(Lang101Ita_01_1.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(Lang101Ita_01_1.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(Lang101Ita_01_1.this, SupportActivity.class);
        ...
        aniLayoutTitle = AnimationUtils.loadAnimation(Lang101Ita_01_1.this, R.anim.descend_fast);
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEnd = new Intent(Lang101Ita_01_1.this, Lang101Ita_01_2.class);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btnPrev:
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(Lang101Ita_01_1.this, Lang101Ita_01_2.class);
