...
public class MonoDeu_01_0 extends AppCompatActivity {
    // Data from DB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mono_deu_01_0);
        ...
        ani1 = AnimationUtils.loadAnimation(MonoDeu_01_0.this, R.anim.descend);
        ani2 = AnimationUtils.loadAnimation(MonoDeu_01_0.this, R.anim.ascend);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intentAccount = new Intent(MonoDeu_01_0.this, MonoDeu_01_1.class);
