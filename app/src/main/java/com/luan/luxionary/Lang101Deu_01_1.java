...
public class Lang101Deu_01_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lang101_deu_01_1);
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(Lang101Deu_01_1.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(Lang101Deu_01_1.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(Lang101Deu_01_1.this, SupportActivity.class);
        ...
        aniLayoutTitle = AnimationUtils.loadAnimation(Lang101Deu_01_1.this, R.anim.descend_fast);
        aniLayoutMain = AnimationUtils.loadAnimation(Lang101Deu_01_1.this, R.anim.fadein);
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEnd = new Intent(Lang101Deu_01_1.this, Lang101Deu_01_2.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(Lang101Deu_01_1.this, Lang101Deu.class);
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // Prev & Next Buttons
                case R.id.btnPrev:
                    Intent intentPrev = new Intent(Lang101Deu_01_1.this, Lang101Deu.class);
                    ...
                    break;
                case R.id.btnNext:
                    Intent intentNext = new Intent(Lang101Deu_01_1.this, Lang101Deu_01_2.class);
                ...
                case R.id.btnSidebar:
                    ...
                    break;
                case R.id.btnHome:
                    Intent intentHome = new Intent(Lang101Deu_01_1.this, MainActivity.class);
