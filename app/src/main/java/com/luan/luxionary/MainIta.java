...
public class MainIta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAccount = new Intent(MainIta.this, AccountActivity.class);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCharge = new Intent(MainIta.this, ChargeActivity.class);
        ...
        btnSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentSupport = new Intent(MainIta.this, SupportActivity.class);
        ...
        aniLlTop = AnimationUtils.loadAnimation(MainIta.this, R.anim.descend);
        llTop.startAnimation(aniLlTop);

        // Title
        layoutProfile = (LinearLayout) findViewById(R.id.layoutProfile);
        aniLayoutProfile = AnimationUtils.loadAnimation(MainIta.this, R.anim.descend);
        layoutProfile.startAnimation(aniLayoutProfile);
        tvTitle1 = (TextView) findViewById(R.id.tvTitle1);
        tvTitle1.setOnClickListener(mClickListener);
        tvTitle2 = (TextView) findViewById(R.id.tvTitle2);
        aniTitle1 = AnimationUtils.loadAnimation(MainIta.this, R.anim.fadein);
        aniTitle1.setStartOffset(600);
        aniTitle2 = AnimationUtils.loadAnimation(MainIta.this, R.anim.fadein);
        ...
        aniLayoutMain = AnimationUtils.loadAnimation(MainIta.this, R.anim.fadein);
    ...
    public void pageVoca() {
        Intent intentVoca = new Intent(MainIta.this, VocaIta.class);
    ...
    public void pageGram() {
        Intent intentGram = new Intent(MainIta.this, GrammarEng.class);
    ...
    public void pageConj() {
        Intent intentConj = new Intent(MainIta.this, ConjEng.class);
    ...
    public void pageGlobal() {
        Intent intentGlobal = new Intent(MainIta.this, GlobalEng.class);
